...
class PhotoController extends Controller
{
    ...
    public function update(Request $request, $gallery, $photo)
    {
        ...
        try {
            ...
            DB::rollBack();
            return redirect()->route('photo.index', $gallery)->with('error', 'Gagal update arsip foto');
        }
    }
    ...
    public function destroy($gallery, $photo)
    {
        try {
            ...
            return redirect()->route('photo.index', $gallery)->with('error', 'Gagal menghapus arsip foto');
        }
    }
